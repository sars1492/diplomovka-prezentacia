...
\begin{frame}{Prehľad citačných registrov}
  %\setbeamercolor{block title}{use=structure,fg=black,bg=blue!75!black}
...
\begin{frame}{Rozdelenie pracovníkov do katedier}
  ...
  \begin{table}
    ...
    \begin{tabular}{llc}
      \toprule%\noalign{\vspace{.3ex}}
      Názov katedry                             & Skr.    & $n^\dagger$\\%[0.3ex]
      \midrule%\noalign{\vspace{.5ex}}
      Katedra biológie                          & KB      & 13$^{\mathrm{a}}$ \\%[0.5ex]
      Katedra biotechnológií                    & KBt     & 10$^{\mathrm{b}}$ \\%[0.5ex]
      Katedra chémie                            & KCh     & 18$^{\mathrm{c}}$ \\%[0.5ex]
      Katedra ekochémie a rádiobiológie         & KER     & 6$^{\mathrm{d}}$ \\%[-0.25ex]
      Kat. aplikovanej informatiky a matematiky & KAIM    & 14$^{\mathrm{e}}$ \\%[-0.25ex]
      Katedra biofyziky                         & KBf     & 6$^{\mathrm{f}}$ \\%[0.5ex]
      Katedra odbornej jazykovej prípravy       & KOIP    & 2$^{\mathrm{g}}$ \\%[-0.25ex]
      \bottomrule
      \multicolumn{3}{l}{\tiny $^\dagger$ počet pracovníkov katedry} \\
      %\tiny{$^{\mathrm{a}}$ \url{http://kb.fpv.ucm.sk/}} & \multicolumn{2}{l}{\tiny $^{\mathrm{b}}$ \url{http://katedra-biotechnologii.webnode.sk/}} \\
      \multicolumn{3}{l}{\tiny $^{\mathrm{a}}$ \url{http://kb.fpv.ucm.sk/}} \\
      \multicolumn{3}{l}{\tiny $^{\mathrm{b}}$ \url{http://katedra-biotechnologii.webnode.sk/}}\\
      \multicolumn{3}{l}{\tiny $^{\mathrm{c}}$ \url{http://kchfpv.weebly.com/}} \\
      \multicolumn{3}{l}{\tiny $^{\mathrm{d}}$ \url{http://ker.fpv.ucm.sk/}} \\
      \multicolumn{3}{l}{\tiny $^{\mathrm{e}}$ \url{http://ki.fpv.ucm.sk/}} \\
      \multicolumn{3}{l}{\tiny $^{\mathrm{f}}$ \url{http://fpv.ucm.sk/sk/katedra-biofyziky.html}} \\
      \multicolumn{3}{l}{\tiny $^{\mathrm{g}}$ \url{http://kaj.fpv.ucm.sk/}} \\
    \end{tabular}
  \end{table}                                  
...
\begin{frame}{Porovnanie KCh FPV s katedrami chemického inžinierstva vybraných troch gréckych univerzít}
  \begin{table}
    ...
    \begin{tabular}{lccclccc}
      ...
      Indikátor & Scopus & WoS & GS & & Atény$^{\mathrm{a}}$ & Solún$^{\mathrm{a}}$ & Patra$^{\star}$ \\
      \midrule
      $n$            & 18    & 18    & 18    & & 72    & 34    & 30    \\
      ...
      \bottomrule
      \multicolumn{8}{l}{\tiny $^\dagger$ počet autorov na publikáciu; $^\ddagger$ počet citácii na publikáciu; $^{\star}$ zdroj: Scopus}
    \end{tabular}
  \end{table}
\end{frame}
