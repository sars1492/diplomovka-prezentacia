...
\begin{frame}{Rozdelenie pracovníkov do katedier}
  \begin{table}
    ...
    \begin{tabular}{llc@{}l}
      ...
      Katedra ekochémie a rádiobiológie         & KER  & \phantom{0}6&\,$^{\mathrm{d}}$ \\
      Kat. aplikovanej informatiky a matematiky & KAIM & 14&\,$^{\mathrm{e}}$ \\
      Katedra biofyziky                         & KBf  & \phantom{0}6&\,$^{\mathrm{f}}$ \\
      Katedra odbornej jazykovej prípravy       & KOIP & \phantom{0}2&\,$^{\mathrm{g}}$ \\
      \bottomrule
