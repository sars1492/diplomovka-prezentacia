...
\begin{frame}{Svetové časopisy s najväčším počtom publikácii z FPV}
  \begin{table}
    ...
    \begin{tabular}{lc@{}lcccc}
      \toprule
      Názov časopisu & $n$&$^{\dagger\ast}$ & IF\,$^{\mathrm{a}}$  & CS\,$^{\mathrm{b}}$            & SJR\,$^{\mathrm{c}}$   & SNIP\,$^{\mathrm{d}}$ \\
      \midrule
      ...
      \bottomrule
      \multicolumn{7}{l}{\tiny $^\dagger$\,počet publikácií FPV} \\
      \multicolumn{7}{l}{\tiny $^\ast$\,zdroj: Scopus a Web of Science (2000-2016)} \\
